...
const dayElement = daysElement.querySelector(`li.trip-days__item`);

render(dayElement, createListTemplate(), `beforeend`);

const eventsElement = dayElement.querySelector(`ul.trip-events__list`);
