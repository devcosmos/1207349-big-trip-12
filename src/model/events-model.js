  ...
  static adaptToClient(event) {
    const adaptedEvent = Object.assign(
        {},
        {
          ...
          endDate: event.date_to ? new Date(event.date_to) : event.date_to,
          startDate: event.date_from ? new Date(event.date_from) : event.date_from,
  ...
  static adaptToServer(event) {
    const adaptedEvent = Object.assign(
        {},
        {
          ...
          "date_from": event.startDate ? new Date(event.startDate) : event.startDate,
          "date_to": event.endDate ? new Date(event.endDate) : event.endDate,
